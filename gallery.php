...
<div class="container-fluid">
    ...
    <div class="container-fluid gallery-section gallery-page p-4 mt-5">
            <div class="gallery2 row mb-5" id="gdata">
                ...
                ?>
                  ...
                  <div data-toggle="modal" data-target=".gallery-modal-lg" data-aos-duration="5000" data-aos ="fade-up" class="col-md-4 mb-4" >
                      <a class="thumb-icon image-popup">  
                        <img src="./admin/<?php echo $img; ?>" onclick="openImg('<?php echo $img; ?>')"  width="100%" alt="" >
                        <i class="fa fa-picture-o fa-style" onclick="openImg('<?php echo $img; ?>')" > </i>
                      </a>
...
<script>
    function openImg(data){
        console.log(data)
        document.getElementById('lightImg').src = "./admin/" + data;
