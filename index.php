...
<body>
<div id="loader">
  <img src="./images/loader.gif" width="50px" alt="">
</div>
...
<div class="container-fluid">
    <div class="row main">
          ...
          <div class="col-md-12 navMob navMobHome position-fixed classinitial onlyIndexNo d-flex align-items-center " id="navMob">
          ...
          <div id="mainCarousel"  class="carousel slide col-md-12 p-0">
                <div class="carousel-item active">
                  <div class="row">
                    <div class="col-md-4"> 
                      <div class="data-head">
                        <h1 > Aurangabad <br><span>Distillery</span> <br>Limited </h1>
                        <div class="d-flex col-md-8 0ffset-md-2 p-0">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-8 ">
...
<div class="container-fluid">
  <div class="row main-about">
      ...
      <div class="data-head col-md-6 offset-md-3">
        <h2 class="text-center"> About <span> Aurangabad <br>Distillery</span> Limited </h2>
        <div class="col-md-10 offset-md-1 bg-dark p-1"></div>
        <p class="col-md-12 text-justify mt-5 h5">
          &nbsp;&nbsp;&nbsp;&nbsp;<b>
          We are one of the leading manufacturers of Rectified Spirit, Denatured Spirit , Neutral Alcohol, Potash , Bio-potash and De potash vinnasses. Our Products are manufactured at our distillery situated at Walchandnagar, Maharashtra with total area of approx 40 Acres.
          <br><br>
          In order to strengthen our business operation and continue to invest in technology, our Company has shifted from manual distillation to automated distillation in the year 2015-16.
        </b>
        </p>
...
<div class="container-fluid bg-light">
  ...
  <div class="container">
    <div class="row products">
        ...
        <p class="col-md-10 text-center offset-md-1 mb-4 mt-3 subhead h5" data-aos-duration="5000" data-aos ="fade-down"> 
          <b> Our Products are manufactured at our distillery situated at Walchandnagar, Maharashtra with total area of 
        ...
        <div class="col-md-12 p-2 mt-5 pr-3">
          <div class="product row" data-aos-duration="5000" data-aos="fade-up">
            <div class="col-md-4 imgBlock">
              <img src="./images/product/rectified2.jpg" alt="">
            </div>
            <div class="col-md-8 content-head">
              <h2 class="col-md-7 offset-md-1 col-12 pl-0"> Rectified Spirit </h2>
              <p class="col-12 text-justify col-md-10 offset-md-1 p-0 mt-4"> 
                <b> Applications - Pharma Industry and Industrial Solvent. </b> <br><br>
        ...
        <div class="col-md-12 p-2 mt-5 pr-3">
          <div class="product row" data-aos-duration="1200"  data-aos="fade-up">
            <div class="col-md-4 imgBlock" data-aos-duration="5000" data-aos="fade-up">
              <img src="./images/product/ExtraNeutralAlchol2.jpg" alt="">
            </div>
            <div class="col-md-8 content-head">
              <h2 class="col-md-7 offset-md-1 col-12 pl-0"> Neutral Alcohol </h2>
              <p class="col-12 text-justify col-md-10 offset-md-1 p-0 mt-4"> 
                <b> Applications - Cosmetics and Aromatic Industry  </b> <br> <br>
        ...
        <div class="col-md-12 p-2 mt-5 pr-3">
          <div class="product row" data-aos-duration="5000" data-aos="fade-up">
            ...
            <div class="col-md-8 content-head pr-4">
              <h2 class="col-md-11 offset-md-1 col-12 pl-0"> Special Denatured Spirit </h2>
              <p class="col-12 text-justify col-md-10 offset-md-1 p-0 mt-4"> 
                <b> Applications - Chemical Industry </b> <br> <br>
        ...
        <!--    </div>-->
        <!--    <div class="col-md-8 content-head">-->
        <!--      <h2 class="col-md-4 offset-md-1 col-12 pl-0"> Ethanol </h2>-->
        <!--      <p class="col-12 text-justify col-md-10 offset-md-1 p-0 mt-4"> -->
        <!--        <b> Applications - Fuel Blending </b> <br> <br>-->
        ...
        <div class="col-md-12 p-2 mt-5 pr-3">
          <div class="product row" data-aos-duration="1200"  data-aos="fade-up">
            ...
            <div class="col-md-8 content-head">
              <h2 class="col-md-4 offset-md-1 col-12 pl-0" > Potash </h2>
              <p class="col-12 text-justify col-md-10 offset-md-1 p-0 mt-4"> 
                <b> Applications - Fertilizer </b> <br> <br>
        ...
        <div class="col-md-12 p-2 mt-5 pr-3">
          <div class="product row" data-aos-duration="1200"  data-aos="fade-up">
            ...
            <div class="col-md-8 content-head">
              <h2 class="col-md-5 offset-md-1 col-12 pl-0" > Bio Potash </h2>
              <p class="col-12 text-justify col-md-10 offset-md-1 p-0 mt-4" > 
                <b> Applications - Organic Fertilizer </b> <br> <br>
                Potash contains soluble potassium, making it an excellent addition to agricultural fertilizer. 
                It ensures proper maturation in a plant by improving overall health, root strength, disease resistance, and yield rates. 
                In addition, potash creates a better final product, improving the color, texture, and taste of food.
             </p>
        ...
        <div class="col-md-12 p-2 mt-5 pr-3">
          <div class="product row" data-aos-duration="1200"  data-aos="fade-up">
            ...
            <div class="col-md-8 content-head">
              <h2 class="col-md-10 offset-md-1 col-12 pl-0"> De Potash Vinnase (DPV)  </h2>
              <p class="col-12 text-justify col-md-10 offset-md-1 p-0 mt-4"> 
                <b> Applications - Animal Feed and Soil Neutrients. </b> <br> <br>
...
<div class="container-fluid p-0">
  <div class="row our-success pt-5 pb-5">
                
    <h1 class="col-md-12 offset-md-0 col-10 offset-1 text-center mt-5 head" data-aos-duration="800" data-aos ="fade-up"> Our Numbers Showcase Our Success <br> <div class="col-md-8 offset-md-2 col-10 offset-1 mt-3 bg-light p-1"></div> </h1>

        <div class="col-md-4 p-3">
          <div class="col-md-12 text-center pt-4 pb-4 success-block" data-aos-duration="800" data-aos ="fade-up">
              <h1 class="display-1">
              ...
              <div class="col-6 offset-3 bg-light mb-3"> </div>
              <h5> Happy Clients </h5>
          </div>  
        </div>
...
<div class="container-fluid">
  <div class="row management">
    <h1 class="text-center col-md-8 offset-md-2" data-aos-duration="5000" data-aos ="fade-up"> Our <span>Management </span> </h1>
   
   
    <div class="col-md-4 mt-5 p-3">
      <div class="col-md-8 offset-md-2 card text-light rounded" data-aos-duration="900" data-aos ="fade-up">
          <div class="col-10 offset-1">
              <img src="./images/team/chairman.jpg" />
          </div>
          <h5 class="text-center mt-5"> Amardeep Singh Sethi </h5>
          <p class="text-center mb-5"> Chairman </p>
      </div>
    </div>
      ...
      <div class="col-md-4 mt-5 p-3">
        <div class="col-md-8 offset-md-2 card text-light rounded" data-aos-duration="900" data-aos ="fade-up">
            <div class="col-10 offset-1">
                <img src="./images/team/md2.jpeg" />
            </div>
            <h5 class="text-center mt-5"> Dharampal Kalani </h5>
            <p class="text-center mb-5"> Managing Director </p>
        </div>
      </div>
    ...
    <div class="col-md-4 mt-5 p-3">
      <div class="col-md-8 offset-md-2 card text-light rounded" data-aos-duration="900" data-aos ="fade-up">
          <div class="col-10 offset-1">
              <img src="./images/team/ed.jpg" />
          </div>
          <h5 class="text-center mt-5"> Karan Yadav</h5>
          <p class="text-center mb-5"> Executive Director </p>
      </div>
    </div>  
...
<div class="container-fluid">
  <div class="row map">
    ...
    <h1 class="col-12 text-center mb-5 display-2" data-aos-duration="800" data-aos ="fade-up">  Find <span> Us </span>  </h1>
  
    <div class="col-md-10 offset-md-1 mt-5" data-aos-duration="800" data-aos ="fade-down">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3793.75789799125!2d74.7887776148856!3d18.036435887692697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2722e02332856b5f!2sAurangabad%20Distillery%20Walchandnagar!5e0!3m2!1sen!2sin!4v1633001874296!5m2!1sen!2sin" allowfullscreen="" loading="lazy"></iframe>
    </div>
  </div>
</div>
...
<script>
  ...
  $(function () { 
    ...
    $(window).scroll(function () { 
        ...
        if (scroll >= 100) { 
            header.removeClass('onlyIndexNo') 
                    .addClass("onlyIndex"); 
        }else { 
            header.removeClass("onlyIndex") 
                    .addClass('onlyIndexNo'); 
        }  
