                ...
                <div class="col-xl-12 mb-4">
                  ...
                  <div class="card shadow mb-4">
                    ...
                    <div class="card-body row">
                        <form action="reportAdded.php" method="POST" enctype="multipart/form-data" class="col-12" >
                            ...
                            <div class="form-group ">
                                ...
                                <input type="date" name="dateTime" class="form-control" id="dateTime" aria-describedby="help" placeholder="Enter the Date" required> 
                            </div>
                    
                            <div class="form-group p-2 col-md-4">
                                <label class="form-label" for="fileToUpload">Select Report</label>
