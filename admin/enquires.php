...
if(isset($_SESSION['username']))
{
  ...
  $sql = "SELECT * FROM enquires ORDER BY id DESC " ;
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Enquires</div>
                      ...
                      <?php 
                            ...
                            ?>
                                ...
                                <tr>
                                      ...
                                      <td> <input type="button" class="btn btn-outline-danger" value="Delete" onclick="window.location='enquireDelete.php?id=<?php echo $id; ?>&report=<?php echo $report; ?>' "> </td>
