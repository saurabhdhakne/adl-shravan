                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Images</div>
                      ...
                      <?php 
                            ...
                            ?>
                                ...
                                <tr>
                                      ...
                                      <td> <input type="button" class="btn btn-outline-primary" value="Open" onclick="window.location='<?php echo $img  ?>' "> </td>

                                      <td> <input type="button" class="btn btn-outline-danger" value="Delete" onclick="window.location='galleryDelete.php?id=<?php echo $id; ?>&img=<?php echo $img; ?>' "> </td>
